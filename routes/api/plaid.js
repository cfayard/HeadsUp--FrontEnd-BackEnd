...
const PLAID_CLIENT_ID = "5e4ff56c9baf5d00135f3a41"; 
const PLAID_SECRET = "51d5add51aafeef3c41c1655f5e4c9"; 
const PLAID_PUBLIC_KEY = "065559fb6c1b46df796add99014df6";
  ...
  (req, res) => {
    ...
    if (accounts) {
      accounts.forEach(function(account) {
        ...
        client
          .getTransactions(ACCESS_TOKEN, ninetyDaysAgo, today)
          .then(response => {
            transactions.push({
